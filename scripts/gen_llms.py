...
zensical/backlog#92 and #80 for the upstream equivalents.

This works from the *rendered* HTML rather than docs/*.md on purpose. The API
reference page is a mkdocstrings directive in source form:
